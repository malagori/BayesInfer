function bayesinfer_output_files2mat(out_file, path_isswoh, path_bsswh, path_iswhc, path_iswohc,path_bswhc, path_stats)
% input:
...
save(out_file, 'isswoh', 'bsswh', 'iswhc', 'iswohc','bswhc', 'statistics', 'hidden_found_fci', 'pdag_tmp', 'pdag_with_hidden', 'bnet');
