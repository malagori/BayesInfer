...
class EquivalenceClass(object):
    ...
    def getOptDagBene(self, vdFile, dataFile, score, outDirectory, totalVaiables, cardinality, variableNames):
        ...
        optDag, allNodesObj = bwObj.readBeneBntBene(cardinality, variableNames)
